...
4. `docs/current-system-analysis.md`
5. `docs/api-spec.md`
6. `docs/database-design.md`
7. `docs/roadmap.md`
8. `backend/main.py`
9. `backend/app/core/config.py`
10. `backend/app/core/deps.py`
11. `backend/app/api/routes/chat.py`
12. `backend/app/api/routes/detections.py`
13. `backend/app/api/routes/users.py`
14. `backend/app/services/chat_service.py`
15. `backend/app/services/detection_service.py`
16. `backend/app/services/user_service.py`
17. `backend/app/repositories/chat_repository.py`
18. `backend/app/repositories/detection_repository.py`
19. `backend/app/integrations/yolo_engine.py`
20. `backend/app/schemas/chat.py`
21. `backend/app/schemas/detection.py`
22. `backend/app/models/chat_log.py`
23. `backend/app/models/detection_task.py`
24. `backend/app/models/detection_object.py`
