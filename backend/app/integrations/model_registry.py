...
_MODEL_SPECS = (
    ...
    YoloModelSpec(
        ...
        expected_sha256="bce8d8fa6cae153bbdcff989ce67f86c7badcb640026e8f30149f09fd59732f5",
    ...
    YoloModelSpec(
        ...
        architecture="YOLO11n + ASFF",
        dataset_variant="7-class multimodal",
        expected_sha256="530e4cd5a2ad8814637d982ffae50d8ceedacaa702bf92cde4040295f3eb6576",
        checkpoint_class_names=SEVEN_CLASS_CHECKPOINT,
        canonical_class_names=SEVEN_CLASS_CANONICAL,
    ),
    YoloModelSpec(
